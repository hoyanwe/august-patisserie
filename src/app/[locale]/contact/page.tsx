    ...
    return (
        <div className="contact-page" style={{
            ...
            <div style={{
                ...
                backgroundSize: '50%',
                filter: 'blur(10px) brightness(1.05) opacity(0.4)',
            ...
            <div className="contact-card" style={{
                ...
                <div style={{ width: '60px', height: '4px', background: '#E0BBE4', margin: '0 auto 2rem' }}></div>
                ...
                <div className="contact-methods" style={{ display: 'grid', gap: '2rem' }}>
                    <div style={{
                        display: 'flex',
                        ...
                        <h3 style={{ margin: 0, fontFamily: 'var(--font-playfair)', fontSize: '1.25rem' }}>{whatsappTitle}</h3>
                        <a
                            href="https://wa.me/60168777483"
                            target="_blank"
                    ...
                    <div style={{
                        ...
                        <h3 style={{ margin: 0, fontFamily: 'var(--font-playfair)', fontSize: '1.25rem' }}>{instagramTitle}</h3>
                        <a
                            href="https://www.instagram.com/august_patisserie"
                            target="_blank"
                            rel="noopener noreferrer"
                            style={{
                                color: '#333',
