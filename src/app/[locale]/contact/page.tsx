        ...
        <div className="ed-page contact2">
            <Reveal className="contact2-inner" step={100} y={20}>
                ...
                <div className="contact2-cards">
                    ...
                    <a className="contact2-card card-hover" href="https://www.instagram.com/august.patisserie/" target="_blank" rel="noopener noreferrer">
                        ...
                        <span className="contact2-card-value">@august.patisserie</span>
                    </a>
                </div>
            </Reveal>
